...
#define OF_DISSECTOR_ADD_UINT dissector_add
#else
#define OF_DISSECTOR_ADD_UINT dissector_add_uint
#endif
...
void dissect_openflow(tvbuff_t *tvb, packet_info *pinfo, proto_tree *tree)
{
...
void proto_reg_handoff_openflow(void)
{
    ...
    if (!initialized) {
        ...
        OF_DISSECTOR_ADD_UINT("tcp.port", OFP_TCP_PORT_OLD, openflow_handle);
        OF_DISSECTOR_ADD_UINT("tcp.port", OFP_TCP_PORT_STD, openflow_handle);
