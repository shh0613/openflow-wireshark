...
public:
    ...
    */
    void createField(std::string key, const char *name, ftenum type, int display,
            const void *strings, guint32 bitmask, bool subtree = false);
    /*!
    ...
    */
    proto_tree* addSubtree(proto_tree* parent, std::string key, tvbuff_t *tvb, guint32 start,
                    guint32 len);
    ...
    */
    ...
    /*! suhuihuang
    \details Adds a string item to the given parent tree.
    The format of the data is determined by the arguments supplied to \link FieldManager::createField \endlink.
    ...
    */
    void addString(proto_tree* parent, std::string key, tvbuff_t *tvb, guint32 start, guint32 len,
            const char *str);
    ...
    */
    proto_item* addBoolean(proto_tree* parent, std::string key, tvbuff_t *tvb, guint32 start,
     ...
     * suhuihuang
     */
    proto_item* addUint(proto_tree* parent, std::string key, tvbuff_t *tvb, guint32 start,
                    guint32 len, guint32 value);
    ...
    \param len Length of the packet data covering this item
    */
    void addDissector(proto_tree* parent, std::string key, tvbuff_t *tvb, packet_info *pinfo,
            dissector_handle_t handle, guint32 start, guint32 len);
